...
<head>
    ...
    <!-- Css -->
    <link rel="stylesheet" href="../../assets/css/Inventory/CssInventory.css">
...
<body>
    ...
    <div id="app">
      ...
      <div class="contenedor active" id="contenedor">
            ...
            >
                ...
                <v-expansion-panel>
                    <v-expansion-panel-header color="#e5520f">
                        <v-icon small class="ml-auto" color="#fff">fas fa-boxes</v-icon>
                        <span class="mr-auto text-active">Invetario</span>
                    ...
                    <v-btn
                            ...
                            href="./Category1.php"
                            >
                            <v-icon x-small class="ml-0" color="#fff">fas fa-box</v-icon>
                    ...
                    <v-btn
                            ...
                            x-small
                            >
                            <v-icon x-small class="ml-0" color="#f8a01c">fas fa-box</v-icon>
                            
                            <span class="ml-auto mr-auto text-a">Categoria 2</span>
        ...
        <script src="../../assets/js/Inventory/mainInventory.js"></script>
